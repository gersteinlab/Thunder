...
public class SimpleChaining
{
    ...
    */
   public static List<Match> chaining(List<Match> matches, boolean debug)
   {
	 ...
	 List<Match> chain = new ArrayList<Match>();
   ...
   public static void test()
   {
	...
	try {
		   System.out.println("Compute the local alignments between two strings\n");
		    ...
		    Aligner_SmithWaterman sw = new Aligner_SmithWaterman(str1,str2);
		    sw.printDPMatrix();
		    SimpleChaining.chaining(sw.getMatches(), true);
		} catch (IOException e) {
